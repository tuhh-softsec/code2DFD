...
def detect_docker_compose(dfd: CDFD) -> None:
    ...
    for m in microservices:
        dfd.add_service(CService(microservices[m]["servicename"], microservices[m]["stereotype_instances"], microservices[m]["tagged_values"], microservices[m]["properties"]))
